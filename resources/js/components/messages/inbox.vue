 ...
 <div class="row">
            <div class="col-lg-12">
                ...
                <div class="email-leftbar card">
                    <div class="d-grid">
                        <button type="button" class="btn btn-danger waves-effect waves-light" @click="openModal">
                            إرسال رسالة
                        </button>
                    </div>
      ...
      no-enforce-focus   @click="openModal"  id="message-modal" centered size="lg" title="إنشاء رسالة">
                <template #modal-header>
                 <h5 class="modal-title">إنشاء رسالة (العدد: {{alluserschecks?countall:usersids.length}}) </h5>
                ...
                <form>
                      ...
                      <textareavue ref="textareavue" :content="message.content"  @message-change="message_change" ></textareavue>
...
export default {
    ...
    updated() {
    // $refs will be populated here
    if(this.$refs.textareavue)
    this.$refs.textareavue.reinitializeTinyMCE()
  },
    methods:{
        getUsers(){
  ...
  confirmButtonClass: 'btn btn-warning btn-block',
      ...
      this.getUsers()
        ...
        //    console.log(this.$refs.textareavue)
        }
    ...
    watch:{
        search(newSearch)
        {
            if(newSearch.length > 2 || newSearch.length=='')
            {
                this.page=1
                this.hasmorepages=true
                this.getUsers()
